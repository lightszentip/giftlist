...
<table class="table">
    ...
    <tbody>
        <?php foreach ($tests as $test): ?>
         <tr>
            <td class="dscr"><?php echo $test['dscr'];?><span><?php echo $test['explain'];?></span></td>
            <td class="res"><?php if ($test['result'] == 'OK') { ?> <img src="img/icons/accept.png"> OK <?php } else if($test['result'] == 'Warning') { ?> <span style="background-color: yellow">Warning</span> <?php } else { ?> <img src="img/icons/cancel.png"> ERROR!<?php } ?> </td>
         </tr>
        <?php endforeach; ?>
    </tbody>
</table>
